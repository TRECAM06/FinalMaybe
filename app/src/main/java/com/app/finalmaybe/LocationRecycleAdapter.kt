...
import java.io.File
// This code generates the recycler and handles the I/O of the location lists
class LocationAdapter(private val context: Context, private val filesAndFolders: Array<File>) :
